...
interface ILeafletMapProps {
	...
	dataCountry?: {
		...
		location_name_en?: string // English name for GeoJSON matching (optional)
		metropolis?: string
	}[]
		...
		>
			...
			{Array.isArray(dataCountry)
				? dataCountry.map((country, index) => {
					...
					// Use location_name_en for GeoJSON matching if available, otherwise use location_name
					const positionName = country.location_name_en || country.location_name
					const position: LatLngTuple = getPosition(positionName)
					return (
						<Marker
							key={index}
							position={position}
