...
export const WhyChooseUs: FC<IWhyChooseUsProps> = ({
  ...
  // ✅ Hydration-safe: chỉ render HTML sau khi mount
  const htmlDescription = mounted ? description : ''
  ...
  return (
    <section className='relative min-h-[40.5625rem] bg-[#F6F6F4] pb-[12.5rem] lg:min-h-lvh sm:pb-[9.56rem] sm:pt-[7.5rem]'>
      <ImageV2
        ...
        width={1600 * 2 || 40}
        height={788 * 2 || 40}
        className='w-futl absolute bottom-0 right-0 h-full object-cover xsm:hidden'
      />
      <ImageV2
        src={'/imgs/bg.webp'}
        alt={'Why Choose Us Background'}
      ...
      <div className='relative z-10 mx-auto flex justify-between sm:max-w-[90rem] xsm:mt-[2.5rem] xsm:px-[1rem]'>
        <div className='max-w-[39.75rem]'>
          ...
          <p
            className='mt-[0.75rem] text-greyscaletext-body body16-r55 sm:mt-[1rem] xsm:body-14'
      ...
      <ImageV2
        ...
        width={1219 * 2 || 40}
        height={585 * 2 || 40}
        className='pointer-events-none absolute right-0 top-[20rem] h-[50rem] w-full object-cover xsm:hidden'
      />
      <ImageV2
        src={background_mb?.url || '/imgs/bg.webp'}
        alt={'Why Choose Us Background'}
        width={1219 * 2 || 40}
        height={585 * 2 || 40}
  ...
  return (
    ...
    >
      ...
      <div className='relative'>
        ...
        <div
          className='text-[rgba(18,18,18,0.87)] body-14'
          dangerouslySetInnerHTML={{__html: htmlDescription || ''}}
          suppressHydrationWarning
        ></div>
      </div>
