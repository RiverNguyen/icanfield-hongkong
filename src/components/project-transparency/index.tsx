      ...
      <div className='scrollbar-hidden absolute left-1/2 top-[22.5rem] z-[9] grid w-[90rem] -translate-x-1/2 grid-cols-5 xsm:left-0 xsm:top-[11rem] xsm:flex xsm:w-full xsm:-translate-x-0 xsm:overflow-x-auto xsm:pl-4'>
        {Criteria.map((item, index) => (
          ...
          >
            ...
            <div
              className='group-hover: xsm:text-[&_p]:text-[rgba(18,18,18,0.87)] px-4 [&_p]:mt-[1rem] [&_p]:text-[1rem] [&_p]:font-normal [&_p]:leading-[150%] [&_p]:tracking-[-0.02rem] [&_p]:text-white xsm:[&_p]:mt-2 xsm:[&_p]:text-[0.875rem] xsm:[&_p]:tracking-[-0.03rem] xsm:[&_p]:text-[rgba(18,18,18,0.87)]'
