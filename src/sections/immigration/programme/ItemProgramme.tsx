...
export default function ItemProgramme({className}: {className?: string}) {
    ...
    return ( 
        <div className={cn("sm:h-[36.75rem] w-full rounded-[1.25rem] border-[0.8px] border-solid border-[rgba(0,0,0,0.08)] bg-white shadow-[0px_4px_11.1px_0px_rgba(114,114,114,0.08)]",
            className
        )}>
                ...
                {isMobile && (
                    <div className="flex items-center space-x-[0.5rem] sm:hidden">
                        <div className="p-[0.5rem_0.75rem] flex-1 rounded-[0.5rem] bg-[rgba(237,237,237,0.16)] blur-[10px]">
                            <p className="body-14-m text-[rgba(255,255,255,0.85)]">Mức đầu tư</p>
            ...
            {!isMobile && (
                <div className="xsm:hidden w-full p-[1.25rem_1.5rem] flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-[1.125rem] text-orangetext-500 font-semibold leading-[133.3%] tracking-[-0.0225rem]">100 triệu USD</p>
                    </div>
                    <div>
                        <p className="body16-m text-greyscaletext-200">Mức đầu tư</p>
                        <p className="text-[1.125rem] text-orangetext-500 font-semibold leading-[133.3%] tracking-[-0.0225rem]">100 triệu USD</p>
            ...
            <div className="flex justify-between items-center p-[1.25rem] xsm:p-[1rem] xsm:space-x-[0.5rem]">
                ...
                >
                    <div 
                        className="transition-all group-hover:bg-[linear-gradient(97deg,#5C321E_-3.86%,#95502F_51.97%,#F5C178_117.18%)] p-[0.875rem] xsm:p-[0.75rem] rounded-[1.875rem] bg-[#F4EEEA]"
                    >
                        <IConMessager className="size-[1.25rem] object-contain" />
                    </div>
                    <p className="xsm:hidden group-hover:text-brown transition-all body-14-m tracking-[-0.0175rem] text-brown">Liên hệ tư vấn</p>
                </Link>
                <Link
                    href={'#'}
                ...
                >
                    <p className="body-14-m tracking-[-0.0175rem] text-white">Xem chi tiết</p>
