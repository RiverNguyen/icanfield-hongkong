	...
	return (
		<section className='mt-[6.25rem] section-container xsm:mt-8'>
			<div className='flex w-full items-end justify-between'>
				...
				<Link href={`${slugLocale}/australian-real-estate`} className='flex h-[3rem] items-center justify-center rounded-[0.5rem] bg-btn-gradient px-[0.75rem] pl-[1.5rem] xsm:hidden'>
