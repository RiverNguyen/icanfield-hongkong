...
export default function ExpertTeamV2({ dataExpertTeam }: { dataExpertTeam: IExpertTeamProps }) {
  ...
  console.log('dataExpertTeam', dataExpertTeam)
                    ...
                    <div className='sticky top-0 bg-white pt-[2rem] pb-[1rem]'>
                      ...
                      </p>
                      {
                        e?.link ? (
                          <Link
                            href={e?.link}
                            className='group mt-[0.75rem] inline-flex items-center gap-[0.5rem] rounded-[0.5rem] bg-orangetext-500 px-[1rem] py-[0.5rem] text-[0.875rem] font-medium text-white shadow-[0px_2px_8px_0px_rgba(0,0,0,0.1)] transition-all duration-200 hover:bg-orangetext-600 hover:shadow-[0px_4px_12px_0px_rgba(0,0,0,0.15)] hover:translate-y-[-0.125rem]'
                          >
                            <span>Xem hồ sơ</span>
                            <svg
