...
export default function ItemExpertTeam({
  ...
  return (
    <div
      className={cn(
        "h-[38.125rem] w-[16.125rem] xsm:w-full xsm:h-[20.94319rem] item-expert-team relative transition-all duration-700",
        className
      )}
    >
      <svg
      ...
      >
        ...
        <defs>
          ...
          >
            <stop offset={0.45} stopColor="#95502F" />
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.164} stopColor="#95502F" />
            <stop offset={1} stopColor="#F5C178" />
          </linearGradient>
          <image
