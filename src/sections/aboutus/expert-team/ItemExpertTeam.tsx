...
export default function ItemExpertTeam({srcImage,index,className}: {srcImage: string;index: number;className?: string}) {
    return (
        <div className={cn('h-[38.125rem] w-[16.125rem] xsm:w-full xsm:h-[20.94319rem] item-expert-team relative transition-all duration-700',
          className
        )}>
          <svg
          ...
          >
            ...
            />
            <path
              className='scale-[1.01] xsm:scale-[1] path-svg'
              fillRule='evenodd'
              clipRule='evenodd'
