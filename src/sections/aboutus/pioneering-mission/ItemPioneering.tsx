...
export default function ItemPioneering({index}: {index: number}) {
    return <div
        className="item__pioneering group relative overflow-hidden w-[44.25rem] xsm:w-full h-[25rem] xsm:h-[11.875rem] xsm:rounded-[0.75rem] rounded-[1.5rem] bg-white shadow-[0px_4px_10px_0px_rgba(0,0,0,0.03)] xsm:shadow-[0px_1.938px_4.845px_0px_rgba(0,0,0,0.03)]"
    >
        <ImageV2
        ...
        <div className="relative z-10 p-[3rem_1rem_2rem_3rem] xsm:p-[1.25rem_0rem_1rem_1.25rem] h-full w-[29.4375rem] xsm:w-[16.25rem] flex flex-col justify-between">
            <div className="[&_p]:sub-24S [&_strong]:sub-24S xsm:[&_p]:text-[0.8125rem] xsm:[&_strong]:text-[0.8125rem] xsm:[&_p]:tracking-[0.00813rem] [&_p]:text-greyscaletext-200 [&_strong]:text-greyscaletext-900 group-hover:[&_p]:text-white group-hover:[&_strong]:text-white group-hover:[&_strong]:font-normal xsm:[&_strong]:font-medium xsm:[&_strong]:text-white xsm:[&_p]:text-white xsm:[&_p]:font-medium xsm:[&_p]:leading-[1.5]">
