...
export default function ItemPioneering({ index }: { index: number }) {
  return (
    <div className="item__pioneering group relative overflow-hidden w-[43.85rem] xsm:w-full h-[25rem] xsm:h-[11.875rem] xsm:rounded-[0.75rem] rounded-[1.5rem] bg-white shadow-[0px_4px_10px_0px_rgba(0,0,0,0.03)] xsm:shadow-[0px_1.938px_4.845px_0px_rgba(0,0,0,0.03)]">
      <ImageV2
      ...
      <div className="relative z-10 p-[3rem_1rem_2rem_3rem] xsm:p-[1.25rem_0rem_1rem_1.25rem] h-full w-[29.4375rem] xsm:w-[16.25rem] flex flex-col justify-between">
        ...
        <p className="text-brown font-optima text-[2.5rem] font-semibold tracking-[-0.05rem] xsm:heading2 xsm:font-semibold xsm:text-white group-hover:text-white group-hover:font-semibold transition-all duration-700 delay-300">
          {index + 1}. Tận Tâm
        </p>
      </div>
