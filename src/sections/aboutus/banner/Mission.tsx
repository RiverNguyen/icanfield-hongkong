...
export default function Mission() {
  ...
  return (
    <section className="relative xsm:z-[11] h-[100.25rem] xsm:h-[56.375rem] xsm:bg-background">
      <ImageV2
      ...
      <div
        ref={ref}
        className="z-20 w-full h-[64.9375rem] xsm:h-[21.4375rem] absolute bottom-0"
      >
        <ImageV2
      ...
      <div
        className={cn(
          ...
          "pointer-events-none xsm:w-full transition-all sm:translate-y-[100%] sm:opacity-0 z-10 absolute left-[50%] translate-x-[-50%] bottom-[3.5rem] xsm:px-[1rem] xsm:bottom-[2.5rem]"
        )}
      >
        <div className="space-y-[0.625rem] xsm:space-y-[0.5rem] flex flex-col items-center mb-[2.5rem]">
          <span className="text-greyscaletext-400 body16 font-semibold xsm:sub-12 xsm:font-medium xsm:tracking-[-0.015rem]">
            SỨ MỆNH CỦA ICANFIELD
          </span>
          <h2 className="text-center w-[55.875rem] xsm:w-full font-optima text-brown text-[3rem] font-semibold leading-[1.2] tracking-[-0.06rem] xsm:heading1">
        ...
        <div className="xsm:p-[1.5rem_1rem] flex flex-col items-center justify-start w-[74.75rem] xsm:w-full h-[60rem] xsm:h-[38.5rem] rounded-[2.5rem] opacity-[0.95] bg-[linear-gradient(180deg,rgba(220,157,96,0.92)_-18.75%,rgba(123,87,53,0.50)_54.27%,rgba(255,255,255,0.45)_63.95%)]">
          <p className="sm:mt-[2.44rem] mb-[2rem] w-[49.3125rem] xsm:w-full text-center text-textwhitetest text-[2.25rem] font-semibold leading-[1.2] tracking-[-0.045rem] xsm:heading2">
          ...
          <div className="flex sm:space-x-[6rem] xsm:grid xsm:grid-cols-2 xsm:gap-[2rem]">
            <div className="flex flex-col items-center">
              ...
              <p className="text-white body16-m xsm:sub-12 xsm:font-medium xsm:tracking-[-0.015rem]">
                Định cư thành công
              </p>
            </div>
            <div className="flex flex-col items-center">
