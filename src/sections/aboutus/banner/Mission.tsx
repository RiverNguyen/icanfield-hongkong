  ...
  return (
    <section className='relative h-[88.25rem] xsm:h-[56.375rem]'>
      <ImageV2
        ...
        width={1200}
        height={800}
        src={'/imgs/homepage/banner/BG-sky.webp'}
      />
      <div
      ...
      >
        <ImageV2
          ...
          width={1300}
          height={1300}
          src={'/imgs/homepage/banner/bg-house2.webp'}
        />
        <ImageV2
      ...
      <ImageV2
        ...
        width={1300}
        height={1300}
        src={'/imgs/homepage/banner/silk-strip.webp'}
      />
      <div
        ref={ref}
        className={cn(
      ...
      >
        <div className='mb-[2.5rem] flex flex-col items-center space-y-[0.625rem] xsm:space-y-[0.5rem]'>
          ...
          <h2
            ...
            className='xsm:heading1 xsm:px-[0.1rem] w-[57.875rem] text-center font-optima text-[3rem] font-semibold leading-[1.2] tracking-[-0.06rem] text-brown xsm:w-full'>
          </h2>
        </div>
