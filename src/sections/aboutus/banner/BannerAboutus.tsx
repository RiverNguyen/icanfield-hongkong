...
export default function BannerAboutus() {
  ...
  return (
    <section
      ref={ref}
      className="xsm:bg-background relative w-full h-[100vh] overflow-hidden z-10"
    >
      {isMobile ? (
      ...
      <ImageV2
        className={cn(
          ...
          "transition-all w-[24.98719rem] h-[16.69144rem] absolute object-cover top-[32%] left-[12%] xsm:w-[10.14275rem] xsm:h-[6.31106rem] xsm:top-[21.31rem] xsm:left-[-0.29rem] xsm:rotate-[-5.462deg]"
        )}
        alt=""
        width={399}
        height={267}
      ...
      <div
        className={cn(
          ...
          "transition-all sm:translate-y-[100%] sm:opacity-0 absolute z-10 top-[13.87rem] sm:right-[11.94rem] xsm:top-[4.44rem] xsm:left-[50%] xsm:translate-x-[-50%] space-y-[1.5rem] xsm:space-y-[1rem] xsm:w-[18.25rem]"
        )}
      >
        <p className="font-optima text-white text-[3.25rem] font-medium leading-[1.2] tracking-[-0.065rem] xsm:text-[1.75rem] xsm:font-semibold xsm:tracking-[-0.035rem]">
          Chúng tôi là
        </p>
        <ImageV2
      ...
      <div
        className={cn(
          ...
          "transition-all sm:translate-y-[100%] sm:opacity-0 absolute left-[5rem] bottom-[3rem] w-[41.625rem] space-y-[1.19rem] xsm:bottom-0 xsm:left-[50%] xsm:translate-x-[-50%] xsm:p-[2.5rem_1rem] xsm:w-full xsm:space-y-[1rem]"
        )}
      >
        <span className="text-brown font-optima text-[2.25rem] font-semibold leading-[1.3] tracking-[-0.09rem] xsm:text-[1.25rem] xsm:tracking-[-0.025rem] xsm:leading-[1.2]">
