...
const TeaEB5Section = () => {
  return (
    <section className='xsm:rounded-none xsm:rounded-tr-0 relative z-10 h-[49.25rem] -translate-y-[3rem] overflow-hidden rounded-tl-[2.5rem] rounded-tr-[2.5rem] bg-background'>
      ...
      <h2 className='text-Phase-1-Gradient absolute left-[12.25rem] top-[16.28rem] z-0 font-optima text-[13.75rem] font-normal leading-[1.2] tracking-[-0.275rem] xsm:hidden'>
        EB-5
      </h2>
      <Swiper
        direction={'vertical'}
