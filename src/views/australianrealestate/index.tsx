  ...
  return (
    <main className='bg-background'>
      <Banner
        ...
        className='z-20 xsm:rounded-bl-[1.25rem] xsm:rounded-br-[1.25rem] [&_.overlay2]:xsm:bg-[linear-gradient(180deg,rgba(0,0,0,0.50)_24.02%,rgba(0,0,0,0.00)_86.12%)]'
        background_pc={
      ...
      />
      <PioneeringValuesAustralia
        data={dataAcf?.section_map}
        dataMap={dataMap}
      />
      ...
      {postRelate?.length && (
        <RelatedArticles
          className='relative z-10 rounded-[0rem] bg-background pb-[6.5rem] pt-[5rem] shadow-[0px_-20px_40px_0px_rgba(0,0,0,0.03)] xsm:rounded-[1.5rem_1rem_2rem_1rem] xsm:pt-[1.5rem]'
